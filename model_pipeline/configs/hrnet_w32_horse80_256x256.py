# model_pipeline/configs/hrnet_w32_horse80_256x256.py
# HRNet-W32 top-down pose estimation for 80 horse keypoints (COCO-style dataset)
import os
import time
...
train_ann_file  = 'coco_files/coco_synth_80.json'
val_ann_file    = 'coco_files/coco_synth_80.json'
metainfo=dict(from_file='model_pipeline/configs/_base_/horse80.py')
...
#train_cfg = dict(by_epoch=True, max_epochs=2, val_interval=1) # <-- Kör under dagen
val_cfg = dict()
test_cfg = dict()
